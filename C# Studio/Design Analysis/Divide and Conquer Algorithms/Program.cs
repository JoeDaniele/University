 ...
 * Time how long it takes for each algorithm to complete the sorting task on average. Please use an input set large enough to provide data suggesting a clear winner. 
