...
public class HW2Part2GCDivisor {
	...
	public static int gcd(int... numbers) {
		...
		for (int i = 2; i < min(numbers); i++) {  //this loop will only run until it reaches the smallest number in the array
			isDivisor = true;
			for (int e : numbers) {
 ...
 * pulled from the function below, and an increment.
 * --briefly describing next function then going back--
 * function min will also have multiple 'numbers' passed through it.
 * this function creates variable min as an array of the numbers passed
 * for each 
 * 
 * 
 * 
