public class MyQueue<T> { //create generic
    private T[]data; //private primitive array ds
    private int front;
    private int end;

    public MyQueue(){ //calls other constructor using THIS and sets queue size to 1000
        this(1000);
    }

    public MyQueue(int size){ //takes size parameter/argument and initializes Q to given size
